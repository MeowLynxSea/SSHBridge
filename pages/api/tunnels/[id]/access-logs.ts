...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    // Use the database method - it handles day-based queries
    const logs = await db.getClientAccessLogs(Number(tunnelId), Number(limit));
    ...
    console.error('Error fetching client access logs:', error);
