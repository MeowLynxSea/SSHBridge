export const jaTranslation = {
  translation: {
    ...
    analysis: {
      tunnelAnalysis: 'トンネル分析',
      noTunnels: '分析に利用可能なトンネルがありません',
      selectTunnel: 'トンネル選択',
      port: 'ポート',
      timeRange: '時間範囲',
      today: '今日',
      ...
      uniqueIPs: 'ユニークIP',
      totalBytesTransferred: '総データ転送量',
      averageConnectionDuration: '平均接続時間',
      topCountries: '国別接続数トップ',
      connections: '接続',
      hourlyActivity: '時間帯別アクティビティ分布',
      connectionLogs: '接続ログ',
      connectionTime: '接続時間',
      clientLocation: 'クライアント位置',
      duration: '期間',
      dataTransfer: 'データ転送',
      upload: 'アップロード',
      download: 'ダウンロード',
      ...
      of: '件中',
      totalRecords: '件の記録',
      noRecordsInRange: '選択した時間範囲で接続記録が見つかりません',
      selectTunnelToView: '分析を表示するにはトンネルを選択してください',
      globalDistribution: 'グローバル分布',
      regionalStats: '地域統計',
      noGeographicData: '地理データがありません',
