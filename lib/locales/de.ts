export const deTranslation = {
  translation: {
    ...
    analysis: {
      tunnelAnalysis: 'Tunnel-Analyse',
      noTunnels: 'Keine Tunnel für die Analyse verfügbar',
      ...
      totalBytesTransferred: 'Gesamtübertragene Daten',
      averageConnectionDuration: 'Durchschnittliche Verbindungsdauer',
      topCountries: 'Top-Länder nach Verbindungen',
      connections: 'Verbindungen',
      hourlyActivity: 'Stündliche Aktivitätsverteilung',
      connectionLogs: 'Verbindungsprotokolle',
      connectionTime: 'Verbindungszeit',
      clientLocation: 'Client-Standort',
      duration: 'Dauer',
      ...
      showingRecent: 'Zeige die letzten',
      of: 'von',
      totalRecords: 'Gesamtzahl der Datensätze',
      noRecordsInRange: 'Keine Verbindungsdatensätze im ausgewählten Zeitbereich gefunden',
      selectTunnelToView: 'Bitte wählen Sie einen Tunnel für die Analyse aus',
      globalDistribution: 'Globale Verteilung',
