export const esTranslation = {
  translation: {
    ...
    analysis: {
      tunnelAnalysis: 'Análisis de Túneles',
      noTunnels: 'No hay túneles disponibles para análisis',
      ...
      totalBytesTransferred: 'Total de Datos Transferidos',
      averageConnectionDuration: 'Duración Promedio de Conexión',
      topCountries: 'Principales Países por Conexiones',
      connections: 'Conexiones',
      hourlyActivity: 'Distribución de Actividad por Hora',
      connectionLogs: 'Registros de Conexión',
      connectionTime: 'Hora de Conexión',
      ...
      showingRecent: 'Mostrando los últimos',
      of: 'de',
      totalRecords: 'registros totales',
      noRecordsInRange:
        'No se encontraron registros de conexión en el rango de tiempo seleccionado',
      selectTunnelToView: 'Por favor seleccione un túnel para ver el análisis',
